<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uctListOfB2BUsers.ascx.cs" Inherits="userControls_uctListOfB2BUsers" %>
			...
			<asp:Repeater ID="rptUsers" runat="server">
				...
				<ItemTemplate>
					<tr class="item">
						...
						<td width="130">
							<div>
								<a href="B2BUser.aspx?userid=<%# DataBinder.Eval(Container.DataItem, "UserID") %>">düzenle</a>, 
