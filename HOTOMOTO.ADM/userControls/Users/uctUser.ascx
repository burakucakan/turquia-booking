...
<div class="b710">
    <div class="title">
        KULLANICI YÖNETÝMÝ</div>
    <div class="main">
        <div class="info">
            Kullanýcý Genel Bilgileri</div>
                ...
                <tr>
                    <td>
                        ...
                        <table width="100%" cellpadding="3" cellspacing="3">
                            <tr>
                                <td>
                                    <asp:Label runat="server" ID="lblCC" Text="Müþteri" />:
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ErrorMessage="Lütfen Þifrenizi Giriniz !" ID="ErrPassword"
